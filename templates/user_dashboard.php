...
<body>
<header>
    <h1>My Online Shopping Platform</h1>
    <nav style="display: flex; justify-content: space-between; align-items: center; max-width: 800px; margin: 0 auto;">
        <div style="display: flex; align-items: center;">
            <a href="user_dashboard.php" style="color: #fff; text-decoration: none; margin-right: 20px;">Home</a>
            <a href="favorite.php" style="color: #fff; text-decoration: none; margin-right: 20px;">Favorite Products</a>
        </div>
        ...
        <div style="display: flex; align-items: center;">
            <a href="logout.php" style="color: #fff; text-decoration: none; margin-right: 20px;">Logout</a>
        </div>
    </nav>
</header>
